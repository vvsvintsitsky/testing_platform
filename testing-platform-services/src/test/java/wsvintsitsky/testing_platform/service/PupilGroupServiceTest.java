...
public class PupilGroupServiceTest {
	...
	public void insertGroup() {
		PupilGroup pupilGroup = new PupilGroup(null, this.institution.getInstitutionSupervisor(), institution, "groupName", null);
		pupilGroup = groupService.saveOrUpdate(pupilGroup);
		Assert.assertNotNull(pupilGroup.getId());
	}
}
